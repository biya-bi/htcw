...
public class FileLogger extends LoggerBase implements Lifecycle {
	...
	public void setDirectory(String directory) {
		...
		propertyChangeSupport.firePropertyChange("directory", oldDirectory, this.directory);
	}
	...
	public void setSuffix(String suffix) {
		...
		this.suffix = suffix;
		propertyChangeSupport.firePropertyChange("suffix", oldSuffix, this.suffix);
	}
	...
	public void setTimestamp(boolean timestamp) {
		...
		propertyChangeSupport.firePropertyChange("timestamp", new Boolean(oldTimestamp), new Boolean(this.timestamp));
	}
	...
	/**
	 * Get the lifecycleSupport listeners associated with this lifecycleSupport. If
	 * this Lifecycle has no listeners registered, a zero-length array is returned.
	 */
	@Override
	...
	/**
	 * Prepare for the beginning of active use of the @Override public methods of
	 * this component. This method should be called after <code>configure()</code>,
	 * and before any of the @Override public methods of the component are utilized.
	 *
	...
	/**
	 * Gracefully terminate the active use of the @Override public methods of this
