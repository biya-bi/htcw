...
import org.rainbow.catalina.connector.RequestStream;
import org.rainbow.catalina.util.Enumerator;
import org.rainbow.catalina.util.ParameterMap;
...
public class HttpRequest implements HttpServletRequest {
	...
	/**
	 * Get the name of the server (virtual host) to process this request.
	 *
	 */
	@Override
